...
class PlayerPanel extends egret.DisplayObjectContainer{
    ...
    player_desc: egret.TextField
    hero_desc: egret.TextField;
    weapon_desc: egret.TextField[] = [];
    ...
    constructor(stage: egret.DisplayObjectContainer, player:Player) {
        super();
        this.player = player;
